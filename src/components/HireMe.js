...
const HireMe = () => {
  return (
    <div className="fixed left-4 bottom-0 flex items-center justify-center overflow-hidden md:right-8 md:left-auto md:top-0 md:bottom-auto md:absolute">
      <div className="w-48 h-auto flex items-center justify-center relative md:w-24">
        <CircularText
          className={"fll-dark animate-spin-slow dark:fill-light"}
        />
        <Link
          href="mailto:napriadi44@gmail.com"
